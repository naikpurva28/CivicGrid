    ...
    <div style={{ display: 'flex', background: '#f8fafc', minHeight: 'calc(100vh - 60px)' }}>
      ...
      <aside style={{ width: '250px', background: 'white', borderRight: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
        ...
        <nav style={{ padding: '1rem 0', flex: 1 }}>
          ...
          <Link href="/alerts" style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', padding: '0.85rem 1.5rem', background: '#0f3b7a', color: 'white', fontWeight: 700, borderLeft: '4px solid #f59e0b', fontSize: '0.92rem', textDecoration: 'none' }}>
      ...
      {/* Main Container */}
      <main style={{ flex: 1, padding: '1.75rem 2.25rem', overflowY: 'auto', overflowX: 'hidden' }}>
